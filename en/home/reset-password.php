...
if(isset($_POST['resetp'])){
	...
	if($arre>0){
		...
		if($msg ==''){
			...
			<p<a href="digitalcoinplace.com/en/reset-password?/'.$confCode.'"> digitalcoinplace.com/en/reset-password?/'.$confCode.
			'</a> </p>
...
<!-- home/reset-password  08:48:56 GMT -->
...
<body>
	<div class="signup-form">
		...
		<form action="" method="post">
			...
			<p>Enter Your Account Email Address Below.</p>
